 ...
 * $_navIsAdmin, $_navIsTeacher, and the _active()/_sectionActive() functions.
 *
...
<aside class="app-sidebar" aria-label="Section navigation">
  ...
  <?php _sbGroup('&#128196;', 'Exams', [
      ...
      ], _sbOpen(['manage.php','questions-hub.php','questions.php','question-edit.php','log.php','setup.php','BulkUploadQuestions.php','ImportExamTemplate.php','ExamSearch.php','AddEditExam.php','ViewExamDetails.php','ExamAttemptOverrides.php','TranslateExam.php','Languages.php'])); ?>
  ...
  <?php
    ...
    _sbGroup('&#128101;', 'Users', [
      ...
      ], _sbOpen(['AdminUsers.php','ManageTeachers.php','SearchUser.php','AddUser.php','ManageInstitutes.php','InstituteStudents.php','BulkAssignInstitute.php','BulkUploadStudents.php','AddStudent.php','AdmittedStudentList.php','SearchStudent.php','ViewStudent.php','EditStudent.php','ChangeUserRole.php','LoginTrack.php','UserChangeRequests.php']));
  ?>
  ...
  <?php _sbGroup('&#128218;', 'Catalog', [
        ...
        ['href'=>$_root.'Admin/CountryInfo.php',                 'icon'=>'&#127760;', 'label'=>'Countries', 'active'=>_sbOpen(['CountryInfo.php','AddEditCountryInfo.php'])],
      ], _sbOpen(['SubjectInfo.php','AddEditSubjectInfo.php','grades.php','groups.php','CountryInfo.php','AddEditCountryInfo.php'])); ?>
  ...
  <?php _sbGroup('&#128181;', 'Payments', [
      ...
      ], _sbOpen(['EnrollmentPayments.php','PendingPayments.php','ManageCoupons.php','InstituteDiscounts.php','FeedbackDashboard.php'])); ?>
  ...
  <?php _sbGroup('&#128250;', 'Monitor', [
      ...
      ], _sbOpen(['LiveExamCenter.php','CheatingDashboard.php','LoginTrack.php','AppSettings.php'])); ?>
