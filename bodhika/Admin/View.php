        ...
        <tr>
			...
			<td class="lakstoppad1" valign="top">
                    ...
                    <table border="0" cellpadding="0" cellspacing="1" width="100%" bgcolor="#EEEEEE">
						...
						<tr>
                        	<td width="18%" class="tbllbl">
                            	Student's Id 
                            </td>
                            
                            <td align="left"  width="22%" class="tblvalue">
...
echo "$output"?>.jpg'>
						...
						echo $rowBusRoute['BusName']." - ".$rowBusRoute['BusDesc']; ?>
                            </td>
                        </tr>
 ...
 <table border="0" cellpadding="0" cellspacing="1" width="100%" bgcolor="#EEEEEE">
			      ...
			      <td align="center" width="17%">
							...
							<?php 
							//print $_GET['AppId'];
							$qry="select * from studentdetails a, studentinfo b , sectioninfo c, gradeinfo d where a.SectionInfoId = c.SectionInfoId and a.StudentInfoId = b.StudentInfoId and a.GradeInfoId=d.GradeInfoId and a.StudentInfoId =".$primkeyId." order by StudentDtlId desc";
							...
							<tr height="24" class="<?php
							   ...
							   <td class="tbldt" align="center">
								 ...
								 <?php echo "<a class='bodynav' href='FeePaymentInfo.php?AppId=$rowEdu[StudentDtlId]'>"."Fees   "."</a>"; ?>
 <?php echo "<a class='bodynav' href='AddEditTermMarks.php?AppId=$rowEdu[StudentDtlId]'>"."Result"."</a>"; ?>
 <?php echo "<a class='bodynav' href='marks.php?StudentDtlId=$rowEdu[StudentDtlId]'>"."Compare Result"."</a>"; ?>
 <?php echo "<a class='bodynav' href='markstermwisereport.php?AppId=$rowEdu[StudentDtlId]'>"."Report"."</a>"; ?>
