...
<form name="frmOrgApp" action="" method="post">
		  ...
		  <?php 
				//$strExeQuery="select a.GradeName,b.GroupName,a.Active from gradeinfo a, groupinfo b where a.GroupId=b.GroupId";
				$strExeQuery="select * from groupinfo a,gradeinfo b where a.GroupId=b.GroupId";
		  ...
		  ?>				
                      <tr class="<?php
                        ...
                        <td align="left">
							...
							<td align="center">
                            <a href="AddEditGradeInfo.php?InfoId=<?php print $Result['GradeInfoId'];?>" class='bodynav'>Edit Group</a> <span class="style1">
					...
					?>
					<tr><td colspan="4" align="right"><a href="export1.php" >Export to MS XL</a></td></tr>
			<tr><td height="22" class="" colspan="4" align="center">

<input name="BtnAddNew" type="button" id="Cancel" value="Add New" style="background-image:url('../Images/btnsmall2.gif');width:100px;height:26px;border:0" class="btnbg" onclick="location.href('AddEditGradeInfo.php?InfoId=0')"/>
