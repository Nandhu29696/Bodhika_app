...
<table border="0" cellpadding="0" cellspacing="0" width="1025" align="center">
	...
	<tr>
			...
			<td class="lakstoppad1" valign="top">
					...
					<form name="frmEditStudent" onSubmit="return checkForm2();" action="UpdateStudentProfile.php?StudentInfoId=<?php print $primkeyId;?>" method="post" enctype="multipart/form-data" >
...
<INPUT size="10" maxlength="10" name=txtDOB value="<?php echo $Row123['DOB']?>" disabled> <A id=anchor2xx 
...
{
?>
	<select id="txtAdmnGrade" name="txtAdmnGrade"  tabindex="8" disabled>
 <option value='select' selected='selected'>Select</option>
<?php
...
?>
	...
	<select id="txtAdmnGrade" name="txtAdmnGrade"  tabindex="9" disabled>
...
{
?>
	<select id="txtSection" name="txtSection"  tabindex="10" disabled>
 <option value='select' selected='selected'>Select</option>
<?php
...
?>
	...
	<select id="txtSection" name="txtSection"  tabindex="11" disabled>
...
?>
	<select id="txtBus" name="txtBus"  tabindex="34" disabled>
 <option value='select' selected='selected'>Select</option>
<?php
...
<td class="tbldt">
                            ...
                            <tr>
                                ...
                                <td class="tbldt" colspan="3">
                                	...
                                	<textarea id="txtNote" name="txtNote" tabindex="40" style="width:90%" rows="5" disabled><?php echo $Row123['Note']?></textarea>                                </td>
