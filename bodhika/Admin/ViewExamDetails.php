...
$UserInfoId = $row['UserInfoId'];
				...
				//$chkstudentexam1="select * from studentexam a,examinfo b  where a.ExamInfoId=b.ExamInfoId and a.ExamInfoId=".$pkid." and UserInfoId =".$UserInfoId ;
				$chkstudentexam1=mysql_query("select * from studentexam a,examinfo b  where a.ExamInfoId=b.ExamInfoId and a.StudentExamId =".$pkid." and UserInfoId =".$UserInfoId );
		//echo $chkstudentexam1;
				//$strExeQuery1=mysql_query($chkstudentexam1,$conn);
					while($chkstudentexamresult=mysql_fetch_array($chkstudentexam1))
					{  
						//echo "inside while";
								$SubjectInfoId = $chkstudentexamresult['SubjectInfoId'];
								$GradeInfoId  = $chkstudentexamresult['GradeInfoId'];
								$NumOfQuestions = $chkstudentexamresult['NumOfQuestions'];
								$MinPassing = $chkstudentexamresult['MinPassing'];
								$Description = $chkstudentexamresult['Description'];
								 
								      
					}


if(isset($_POST['hdntxtAdmnGrade']))
$Grade=$_POST['hdntxtAdmnGrade'];
else
$Grade=$GradeInfoId;
//$Section=$_POST['hdntxtSection'];
if(isset($_POST['hdntxtSubject']))
$Subject=$_POST['hdntxtSubject'];
else
$Subject=$SubjectInfoId;
//$Term=$_POST['hdntxtTerm'];
if(isset($_POST['hdnMarksOutOf']))
$MarksOutOf=$_POST['hdnMarksOutOf'];
else
$MarksOutOf=$NumOfQuestions;
if(isset($_POST['hdnPassingMarks']))
$PassingMarks=$_POST['hdnPassingMarks'];
else
$PassingMarks=$MinPassing;

/*
if(isset($_POST['StudentExamId']))
 ...
 <td colspan="2" class="tbldt">
  ...
  <tr height="24">
				...
				<td align="center"  >
						...
						$qry="select * from answers a, questions b, examinfo c ,studentexam d ,studentexamresults e where a.QuestionId=b.QuestionId and  d.StudentExamId=e.StudentExamId and a.QuestionId=e.QuestionId and d.ExamInfoId=c.ExamInfoId  and d.UserInfoId =".$UserInfoId." and d.StudentExamId =".$pkid;
//echo $qry;
...
$CorrectAnswer =str_replace("Answer","",$CorrectAnswer);
	...
	$studentAnswer=$Result['StdAnswerId'];
	$chkans1="";
	$chkans2="";
	$chkans3="";
	$chkans4="";
...
//echo "studentAnswer: ".$studentAnswer;
//echo "chkans1: ".$chkans1;
//echo "chkans2: ".$chkans2;
...
?>
 <input type="radio" name="rdoAnswer" id="rdoAnswer" tabindex="3" value="Answer1" checked="<?php echo $chkans1;?>" disabled/>
	...
	?>
			 ...
			 <input type="radio" name="rdoAnswer" id="rdoAnswer" tabindex="3" value="Answer1" checked="<?php echo $chkans1;?>" disabled/> <?php echo $Answer1;?>
 <?php
		}
	?>
...
?>
 <input type="radio" name="rdoAnswer" id="rdoAnswer" tabindex="3" value="Answer2" checked="<?php echo $chkans2;?>" disabled/>
	...
	?>
			 ...
			 <input type="radio" name="rdoAnswer" id="rdoAnswer" tabindex="3" value="Answer2" checked="<?php echo $chkans2;?>" disabled/> <?php echo $Answer2;?>
 <?php
		}
	?>
...
<td align="center" bgcolor="<?php echo $bgcolor3;?>"> 
...
?>
 <input type="radio" name="rdoAnswer" id="rdoAnswer" tabindex="3" value="Answer3" checked="<?php echo $chkans3;?>" disabled/>
	...
	?>
			 ...
			 <input type="radio" name="rdoAnswer" id="rdoAnswer" tabindex="3" value="Answer3" checked="<?php echo $chkans3;?>" disabled/> <?php echo $Answer3;?>
 <?php
		}
	?>
...
<td align="center" bgcolor="<?php echo $bgcolor4;?>"> 
...
?>
 <input type="radio" name="rdoAnswer" id="rdoAnswer" tabindex="3" value="Answer4" checked="<?php echo $chkans4;?>" disabled/>
	...
	?>
			 ...
			 <input type="radio" name="rdoAnswer" id="rdoAnswer" tabindex="3" value="Answer4" checked="<?php echo $chkans4;?>" disabled/> <?php echo $Answer4;?>
 <?php
		}
	?>
...
$i++;
	...
	?>
						...
						<tr>
                            	<td class="HeaderStyle" align="center" colspan="9" height="24">&nbsp;<b>
					<?php
...
<tr height="22">
					...
					<input type="submit" value="Save" name="save" id="save" tabindex="16" style="background-image:url('../Images/btnsmall2.gif');width:100px;height:26px;border:0" class="btnbg"/>
						...
						<input type="button" value="Back" tabindex="15" class="btnbg"  onClick='backbtn()' style="background-image:url('../Images/btnsmall2.gif');width:100px;height:26px;border:0"/>
...
<input type="hidden" value="<?php echo $NEW_ID; ?>" name="StudentExamId" />
