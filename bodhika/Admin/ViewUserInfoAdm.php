                           ...
                           <?php echo $Row['Mobile']; ?>                                </td>
                            ...
                            <tr>
                                     ...
                                     <!-- input name="BtnCancel" type="button" id="Cancel" value="Back" style="background-image:url('../Images/btnsmall2.gif');width:100px;height:26px;border:0" class="btnbg" onclick="history.go(-1);"/ -->
									  <input type="button" value="Back" name="btnCancel" tabindex="15"  style="background-image:url('../Images/btnsmall2.gif');width:100px;height:26px;border:0" class="btnbg" onclick="location.href('AdmittedStudentList.php')"/>
